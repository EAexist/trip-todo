...
export const demoFr: DemoTranslations = {
  ...
  demoTextField: {
    description:
      "Le composant <TextField /> permet la saisie et l'édition de texte.",
    useCase: {
      statuses: {
        name: 'Statuts',
        description:
      ...
      passingContent: {
        ...
        rightAccessory: {
          ...
          helper:
            'Cette prop demande une fonction qui retourne un élément React.',
        },
        leftAccessory: {
      ...
      styling: {
        ...
        styleLabel: {
          ...
          helper:
            'Via les props de style `LabelTextProps` et `HelperTextProps`',
        },
        styleAccessories: {
  ...
  demoToggle: {
    ...
    useCase: {
      ...
      statuses: {
        ...
        disabledStatus:
          'Statut désactivé - désactive l’édition et atténue le style',
      },
      passingContent: {
        name: 'Transfert de contenu',
        description: 'Il y a plusieurs façons de transmettre du contenu.',
        useCase: {
          ...
          checkBoxMultiLine: {
            helper:
              'Supporte le multiligne - Nulla proident consectetur labore sunt ea labore. ',
          },
          radioChangeSides: {
            helper:
  ...
  demoListItem: {
    ...
    useCase: {
      ...
      icons: {
        name: 'Icônes',
        description:
          'Vous pouvez personnaliser les icônes à gauche ou à droite.',
    ...
    useCase: {
      ...
      verticalAlignment: {
        ...
        center: {
          heading: 'Centre',
          content:
            'Le contenu est centré par rapport à la hauteur de la carte.',
          footer: 'Moi aussi !',
        },
        spaceBetween: {
  ...
  demoText: {
    ...
    useCase: {
      ...
      weights: {
        ...
        semibold:
          'demi-gras - Exercitation magna nostrud pariatur laborum occaecat aliqua.',
      ...
      passingContent: {
        ...
        children:
          'enfants - Aliqua velit irure reprehenderit eu qui amet veniam consectetur.',
    ...
    useCase: {
      ...
      passingContent: {
        ...
        customizeImageContent:
          "Vous pouvez passer n’importe quelle source d'image.",
