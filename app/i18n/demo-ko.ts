...
export const demoKo: DemoTranslations = {
    ...
    useCase: {
      variants: {
        ...
        switch: {
          label: '`스위치` 변형',
          helper:
            '더 눈에 띄는 켜기/끄기 입력입니다. 접근성 지원이 더 좋습니다.',
        },
      },
      statuses: {
        name: '상태',
        ...
        disabledStatus:
          '비활성 상태 - 편집 기능을 비활성화하고 입력을 표시하지 않음',
      },
      passingContent: {
        name: '내용 전달',
        description: '내용을 전달하는 몇 가지 방법이 있습니다.',
        useCase: {
          ...
          checkBoxMultiLine: {
            helper:
              '멀티라인 지원 - 멀티라인 지원을 위한 예제 문장입니다. 하나 둘 셋.',
          },
          radioChangeSides: {
            helper:
              '양쪽을 변경할 수 있습니다 - 양쪽 변경을 위한 예제 문장입니다. 하나 둘 셋.',
          },
          customCheckBox: {
  ...
  demoButton: {
    ...
    useCase: {
      ...
      passingContent: {
        ...
        nestedChildren:
          '중첩 자식 - 별 하나에 추억과 별 하나에 사랑과 별 하나에 쓸쓸함과',
  ...
  demoListItem: {
    description:
      'FlatList, SectionList 또는 자체적으로 사용할 수 있는 스타일된 행 컴포넌트입니다.',
    useCase: {
      height: {
        name: '높이',
      ...
      separators: {
        name: '구분선',
        description:
          '구분선 / 디바이더가 사전 구성되어 있으며 선택 사항입니다.',
      ...
      customLeftRight: {
        ...
        description:
          '필요시에는 사용자가 정의한 왼쪽/오른쪽 컴포넌트를 전달할 수 있습니다.',
      ...
      listIntegration: {
        ...
        description:
          '이 컴포넌트는 선호하는 리스트 인터페이스와 쉽게 통합할 수 있습니다.',
      },
      styling: {
        name: '스타일링',
        description: '컴포넌트는 쉽게 스타일링할 수 있습니다.',
  ...
  demoCard: {
    ...
    useCase: {
      ...
      verticalAlignment: {
        name: '수직 정렬',
        description:
          '카드는 필요에 따라 미리 구성된 다양한 정렬방법으로 제공됩니다.',
        top: {
          heading: '상단 (기본값)',
  ...
  demoAutoImage: {
    description:
      '원격 또는 data-uri 이미지의 크기를 자동으로 조정하는 Image 컴포넌트입니다.',
    useCase: {
  ...
  demoHeader: {
    ...
    useCase: {
      actionIcons: {
        name: '액션 아이콘',
        description:
          '왼쪽 또는 오른쪽 액션 컴포넌트에 아이콘을 쉽게 전달할 수 있습니다.',
      ...
      actionText: {
        name: '액션 텍스트',
        description:
          '왼쪽 또는 오른쪽 액션 컴포넌트에 텍스트를 쉽게 전달할 수 있습니다.',
