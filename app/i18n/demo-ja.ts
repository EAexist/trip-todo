...
export const demoJa: DemoTranslations = {
    ...
    useCase: {
      ...
      passingContent: {
        ...
        useCase: {
          ...
          checkBoxMultiLine: {
            helper:
              '複数行サポート - Nulla proident consectetur labore sunt ea labore. ',
          },
          radioChangeSides: {
            helper:
              '左右に変更 - Laborum labore adipisicing in eu ipsum deserunt.',
          },
          customCheckBox: {
            label: 'カスタムアイコンも渡せます',
          },
      ...
      styling: {
        ...
        styleContainer:
          'もしくは、コンポーネントのコンテナ全体をスタイルすることもできます。',
      },
    },
  },
  demoButton: {
  ...
  demoListItem: {
    ...
    useCase: {
      height: {
        ...
        longText:
          'テキストを1行に制限する- Reprehenderit incididunt deserunt do do ea labore.',
      },
      separators: {
        name: 'セパレーター',
  ...
  demoAutoImage: {
    description:
      'リモートまたはデータURIによって自動的にサイズを変更する画像コンポーネントです。',
    useCase: {
  ...
  demoText: {
    ...
    useCase: {
      ...
      weights: {
        ...
        medium:
          'ミディアム - Non duis laborum quis laboris occaecat culpa cillum.',
        semibold:
          'セミボールド - Exercitation magna nostrud pariatur laborum occaecat aliqua.',
      ...
      passingContent: {
        ...
        viaTx: '`tx`から -',
        children:
          'childrenから - Aliqua velit irure reprehenderit eu qui amet veniam consectetur.',
