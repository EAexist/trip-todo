...
export const demoAr: DemoTranslations = {
    ...
    useCase: {
      variants: {
        ...
        switch: {
          label: "'switch' متغير",
          helper:
            'مدخل تشغيل/إيقاف أكثر بروزا. يتمتع بدعم إمكانية الوصول بشكل أفضل.',
        },
      },
      statuses: {
        name: 'الحالات',
      ...
      passingContent: {
        ...
        useCase: {
          ...
          checkBoxMultiLine: {
            helper:
              'يدعم خطوط متعددة-Nulla provident consectetur labore sunt ea labore ',
          },
          radioChangeSides: {
            helper:
              'يمكنك تغيير الجانبين - Laborum labore adipisicing in eu ipsum deserunt.',
          },
          customCheckBox: {
  ...
  demoButton: {
    ...
    useCase: {
      presets: {
        ...
        description:
          'هناك عدد قليل من الإعدادات المسبقة التي تم تكوينها مسبقاً',
      },
      passingContent: {
        name: 'محتوى عابر',
        description: 'هناك عدة طرق مختلفة لتمرير المحتوى',
      ...
      disabling: {
        name: 'تعطيل',
        description:
          'يمكن تعطيل المكون، وتصميمه بناء على ذلك. سيتم تعطيل سلوك الضغط',
  ...
  demoListItem: {
    description:
      'مكون صف مصمم يمكن استخدامه في FlatList او SectionList او بمفرده',
    useCase: {
      height: {
        name: 'علو',
        ...
        longText:
          'تحديد النص إلى سطر واحد - Reprehenderit incididunt deserunt do do ea labore.',
      },
      separators: {
        name: 'الفواصل',
  ...
  demoHeader: {
    description:
      'المكون الذي يظهر على العديد من الشاشات، سيحمل ازرار التنقل وعنوان الشاشة.',
    useCase: {
      actionIcons: {
        name: 'أيقونة الإجرائات ',
        description:
          'يمكنك بسهولة تمرير الرموزالى مكونات الاجراء اليسرى او اليمنى.',
      ...
      actionText: {
        name: 'نص العمل',
        description:
          'يمكنك بسهولة تمرير النص الى مكونات الاجراء اليسرى او اليمنى.',
