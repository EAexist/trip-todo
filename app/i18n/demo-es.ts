...
export const demoEs: DemoTranslations = {
  ...
  demoTextField: {
    description:
      'El componente <TextField /> permite el ingreso y edición de texto.',
    useCase: {
      statuses: {
        name: 'Estados',
        description:
      ...
      passingContent: {
        ...
        rightAccessory: {
          ...
          helper:
            'Este atributo requiere una función que retorne un elemento React.',
        },
        leftAccessory: {
      ...
      styling: {
        ...
        styleLabel: {
          ...
          helper:
            'A través de las props de estilo `LabelTextProps` y `HelperTextProps`',
        },
        styleAccessories: {
          label: 'Estilo de los accesorios',
          helper:
            'A través de las props de estilo `RightAccessory` y `LeftAccessory`',
        },
      },
    },
  },
  demoToggle: {
    ...
    useCase: {
      ...
      statuses: {
        ...
        disabledStatus:
          'Estado desactivado - desactiva la edición y silencia el input',
      },
      passingContent: {
        name: 'Entregando contenido',
        description: 'Hay varias formas de entregar contenido.',
        useCase: {
          ...
          checkBoxMultiLine: {
            helper:
              'Soporta multi líneas - Nulla proident consectetur labore sunt ea labore.',
          },
          radioChangeSides: {
            helper:
  ...
  demoButton: {
    ...
    useCase: {
      ...
      styling: {
        ...
        styleAccessories:
          'Estilo de los componentes - enim ea id fugiat anim ad.',
  ...
  demoListItem: {
    ...
    useCase: {
      ...
      icons: {
        name: 'Íconos',
        description:
          'Puedes personalizar los íconos a la izquierda o a la derecha.',
    ...
    useCase: {
      ...
      verticalAlignment: {
        ...
        top: {
          ...
          content:
            'Todo el contenido está automáticamente alineado en la parte superior.',
          footer: 'Incluso en el pie de página',
        },
        center: {
          heading: 'Centro',
          content:
            'El contenido está centrado en relación con la altura de la tarjeta.',
          footer: '¡Yo también!',
        },
        spaceBetween: {
  ...
  demoText: {
    ...
    useCase: {
      ...
      weights: {
        ...
        semibold:
          'seminegrita - Exercitation magna nostrud pariatur laborum occaecat aliqua.',
  ...
  demoEmptyState: {
    ...
    useCase: {
      ...
      passingContent: {
        ...
        customizeImageContent:
          'Puedes pasar cualquier una imagen de distintas fuentes.',
