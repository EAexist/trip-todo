...
export const demoHi: DemoTranslations = {
  ...
  demoTextField: {
    description:
      'टेक्स्टफील्ड कंपोनेंट टेक्स्ट दर्ज करने और संपादित करने की अनुमति देता है।',
    useCase: {
      statuses: {
        name: 'स्थितियाँ',
        description:
      ...
      styling: {
        ...
        styleLabel: {
          ...
          helper:
            '`LabelTextProps` और `HelperTextProps` स्टाइल प्रॉप के माध्यम से',
        },
        styleAccessories: {
          label: 'सहायक स्टाइल',
          helper:
            '`RightAccessory` और `LeftAccessory` स्टाइल प्रॉप के माध्यम से',
        },
      },
    },
  },
  ...
  demoListItem: {
    ...
    useCase: {
      ...
      separators: {
        name: 'विभाजक',
        description:
          'विभाजक / डिवाइडर पूर्व-कॉन्फ़िगर किया गया है और वैकल्पिक है।',
  ...
  demoHeader: {
    ...
    useCase: {
      actionIcons: {
        name: 'एक्शन आइकन',
        description:
          'आप आसानी से बाएँ या दाएँ एक्शन कंपोनेंट्स में आइकन पास कर सकते हैं।',
      ...
      actionText: {
        name: 'एक्शन टेक्स्ट',
        description:
          'आप आसानी से बाएँ या दाएँ एक्शन कंपोनेंट्स में टेक्स्ट पास कर सकते हैं।',
