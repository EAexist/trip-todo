...
export const BackButton: FC<
    TouchableOpacityProps & { onBackPressBeforeNavigate?: () => Promise<any>, navigateProps?: NavigateProps }
> = ({ onBackPressBeforeNavigate, navigateProps }) => {

    const { navigateWithTrip } = useNavigate()
    const _navigate = navigateProps ? () => navigateWithTrip(navigateProps.name, navigateProps.params) : goBack
